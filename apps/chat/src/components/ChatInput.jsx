...
const ChatInput = ({
    ...
    const { isListening, startListening, stopListening, hasSpeechRecognition } =
        useSpeech();
                ...
                <div className="chat-input-wrapper-modern">
                    ...
                    <div className="chatbar-bottom">
                        <div className="chatbar-left">
                            ...
                            {(mode === "imagine" || mode === "video") &&
                                onOpenGenerationOptions && (
                                    <button
                                        type="button"
                                        className="generation-options-btn"
                                        onClick={() =>
                                            onOpenGenerationOptions(mode)
                                        }
                        ...
                        <div className="chatbar-right">
                            ...
                            {isGenerating ? (
                                <button
                                    className="send-btn-modern stop-btn"
                                    onClick={onStop}
